...
export default function LandingPage() {
  ...
  <div className = "flex-col justify-">
    ...
    <div className="h-[82vh] w-full bg-[#f9fafb] relative">
    <div
      ...
      <div className="container mx-auto px-4 py-8 relative z-1 space-y-6">
        <h1 className="text-6xl font-bold text-center text-primary">A Unified & Actionable View of Overall Website Health</h1>
        <p className="text-center text-lg text-secondary mx-16 ">Are you a Web-Developer, Freelancer or Student, trying to build a optimized web? <b>SiteSense</b> helps you test the <b>Performance</b>, <b>UX</b>, <b>SEO</b> and <b>Security</b> of your website — all in one place.</p>
